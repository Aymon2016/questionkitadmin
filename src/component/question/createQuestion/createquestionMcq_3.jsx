...
const CreateQuestionMcq_3 = () => {
    ...
    const checkValidity = (values) => {
        ...
        const { serial, classes, bookName, chapter, type, image, question, question_i, question_ii, question_iii, option_a, option_b, option_c, option_d, answer } = values;
    ...
    const sendData = async (e) => {
        ...
        const { serial, classes, bookName, chapter, type, image, question, question_i, question_ii, question_iii, option_a, option_b, option_c, option_d, answer } = questions
        if (isValid) {
            ...
            await axios.post(`${URL}/api/v1/questions`, {
                ...
                body: JSON.stringify({
                    serial, classes, bookName, chapter, type, image, question, question_i, question_ii, question_iii, option_a, option_b, option_c, option_d, answer
                })
...
export default CreateQuestionMcq_3